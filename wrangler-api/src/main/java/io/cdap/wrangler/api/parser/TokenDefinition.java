...
public final class TokenDefinition implements Serializable {
    ...
    // Define constants for new token types
    public static final TokenDefinition BYTE_SIZE_DEFINITION = new TokenDefinition("byte_size", TokenType.BYTE_SIZE, null, 0, false);
    public static final TokenDefinition TIME_DURATION_DEFINITION = new TokenDefinition("time_duration", TokenType.TIME_DURATION, null, 1, false);
